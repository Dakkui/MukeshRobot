...
if ENV:
    ...
    DB_URI = os.environ.get("DATABASE_URL", "postgres://sdjswknf:RF8xa4egOVHWKAsN_f4h3sSYBIdAwnly@queenie.db.elephantsql.com/sdjswknf")
    ...
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "PunjabiChat_Group")
    ...
    try:
        ...
        DEV_USERS = set(int(x) for x in os.environ.get("DEV_USERS", "6006788639").split())
    except ValueError:
